...
insert into Adeudo (Concepto, Descripcion, CostoTotal, Id_Cliente)
values('M','Baño y corte de pelo', '180',1);
...
SELECT * FROM CLIENTE;
-- Forma de obtener el último ID introducido en la tabla adeudo
SELECT MAX(Id_Adeudo)  AS ID FROM Adeudo;
